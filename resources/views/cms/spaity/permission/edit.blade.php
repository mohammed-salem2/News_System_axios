                                ...
                                <div class="row">
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <select class="form-control" id="guard_name" name="guard_name" style="width: 100%;" aria-label=".form-select-sm example">
                                            <option @if ($permissions->guard_name == 'admin')
                                                selected
                                            @endif  value="admin">Admin</option>
                                            <option @if ($permissions->guard_name == 'author')
                                                selected
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name"
                                            placeholder="Enter Name of the Role" value="{{ $permissions->name }}">
                                    </div>
                                </div>
                            </div>
                            <!-- /.card-body -->
                            <div class="card-footer">
                                <button onclick="performUpdate({{ $permissions->id }})" type="button" class="btn btn-primary">Store</button>
...
@section('jsFile')
    ...
    <script>
        function performUpdate(id) {
            ...
            store('/cms/admin/permissions-update/'+id, formData);
