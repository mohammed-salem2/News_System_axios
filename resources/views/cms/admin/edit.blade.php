                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="first_name" id="first_name" value="{{ $admins->user->first_name }}"
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <input type="email" class="form-control" name="email" id="email"
                                            placeholder="Enter Email" value="{{ $admins->email }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <select class="form-control" id="country_id" name="country_id">
                                            ...
                                            <option @if ($country->id==$admins->user->country->id)
                                                selected
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <select class="form-control" id="city_id" name="city_id">
                                            ...
                                            <option @if ($city->id==$admins->user->city->id)
                                                selected
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <input type="text" class="form-control" name="adress" id="adress"
                                            placeholder="Enter Adress" value="{{ $admins->user->adress  }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        <label>birth</label>
                                        <input type="date" class="form-control" name="birth" id="birth" value="{{ $admins->user->birth }}">
                                    </div>
                                    <div class="form-group col-12 col-md-6">
                                        <label>Image</label>
