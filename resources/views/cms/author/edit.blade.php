                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="first_name" id="first_name" value="{{ $authors->user->first_name }}"
                                            placeholder="Enter First Name">
                                    </div>
                                    <div class="form-group col-12 col-md-6">
                                        <label for="last_name">Last Name</label>
                                        <input type="text" class="form-control" name="last_name" id="last_name"
                                            placeholder="Enter Last Name" value="{{ $authors->user->last_name }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <input type="email" class="form-control" name="email" id="email"
                                            placeholder="Enter Email" value="{{ $authors->email }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <select class="form-control" id="country_id" name="country_id">
                                            ...
                                            <option @if ($country->id==$authors->user->country->id)
                                                selected
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <select class="form-control" id="city_id" name="city_id">
                                            ...
                                            <option @if ($city->id==$authors->user->city->id)
                                                selected
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <input type="text" class="form-control" name="adress" id="adress"
                                            placeholder="Enter Adress" value="{{ $authors->user->adress  }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <input type="number" class="form-control" name="mobile" id="mobile"
                                            placeholder="Enter Mobile" value="{{ $authors->user->mobile  }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            ...
                                            <option @if ($authors->user->status == 'active')
                                                selected
                                            @endif  value="active">Active</option>
                                            <option @if ($authors->user->status == 'non-active')
                                                selected
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <select class="form-control" id="gender" name="gender">
                                            ...
                                            <option @if ($authors->user->gender == 'male')
                                                selected
                                            @endif value="male">Male</option>
                                            <option  @if ($authors->user->gender == 'female')
                                                selected
                                    ...
                                    <div class="form-group col-12">
                                        <label>birth</label>
                                        <input type="date" class="form-control" name="birth" id="birth" value="{{ $authors->user->birth }}">
                                    </div>
                                    <div class="form-group col-12">
