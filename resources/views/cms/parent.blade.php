                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{ asset('cms/dist/img/AdminLTELogo.png') }}" alt="User Avatar"
                                    class="img-size-50 img-circle mr-3">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        Nora Silvester
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        {{-- <img src="{{ asset('cms/dist/img/user2-160x160.jpg') }}" class="img-circle elevation-2"
                            ...
                            <img class="img-circle elevation-3 img-bordered-sm" style="width:30px; highet:30px;"  src="{{ asset('storage/images/admin/'.auth('admin')->user()->images) }}" alt="User Image">
                            @endif
                            @elseif (Auth::guard('author')->id())
                            @if (auth('author')->user()->images !='')
                            <img class="img-circle elevation-3 img-bordered-sm" style="width:30px; highet:30px;" src="{{ asset('storage/images/author/'.auth('author')->user()->images) }}" alt="User Image">
                            @endif
                            @endif
                    </div>
                    <div class="info">
                        @if (Auth::guard('admin')->id())
                        <p class="d-block text-white">{{ auth('admin')->user()->full_name }}</p>
                        @elseif (Auth::guard('author')->id())
                        <p class="d-block text-white">{{ auth('author')->user()->full_name }}</p>
                        @endif
                    </div>
                </div>
